RACES = {
    "Aarakocra": [],
    "Dragonborn": [
        "Black Scale Dragonborn",
        "Blue Scale Dragonborn",
        "Brass Scale Dragonborn",
        "Bronze Scale Dragonborn",
        "Copper Scale Dragonborn",
        "Gold Scale Dragonborn",
        "Green Scale Dragonborn",
        "Red Scale Dragonborn",
        "Silver Scale Dragonborn",
        "White Scale Dragonborn"
        ],
    "Dwarf": [
        "Mountain Dwarf",
        "Hill Dwarf"
...
CLASSES = {
    "Artificer":[
        "Alchemist Speciliast Artificer",
        "Armorist Speciliast Artificer",
        "Artilierist Speciliast Artificer",
        "Battle Smith Speciliast Artificer"
        ],
    "Barbarian":[
        "Path of the Ancestral Guardian Barbarian",
        "Path of the Beast Barbarian",
        "Path of the Battleranger Barbarian",
        "Path of the Berserker Barbarian",
        "Path of the Storm Herold Barbarian",
    ...
    "Fighter":[
        ...
        "Eldrich Knight Archetype Fighter",
        "Psi Warrior Archetype Fighter",
        "Rune Archetype Fighter",
        "Samurai Archetype Fighter"
        ],
    "Monk":[
        "Way of the Drunken Warrior Monk",
    ...
    "Warlock":[
        ...
        ], #"Queen of Spiders Patron Warlock", "Ancient Dragon Patron Warlock", "Mysterious Feline Patron Warlock", "Raven Queen Patron Warlock", "Serpent Patron Warlock"]
    "Wizard":[
        "Abjuration Arcane Tradition Wizard",
        "Bladesinger Arcane Tradition Wizard",
...
BACKGROUND = {
    "Acolyte": {
        ...
        "Ideal": [
            "Tradition - The ancient traditions of worship and sacrifice must be upheld.",
            "Charity - I always try to help those in need, no matter what the personal cost.",
            "Change - We must help to bring about the changes the gods are constantly working in the world.",
            "Power - I hope to one day rise to top of my faith’s religious hierarchy.",
        ...
        "Bond": [
            ...
            "I seek to preserve a sacred text that my enemies considered heretical and seek to destroy."
        ],
        "Flaw": [
            "I judge others harshly, and myself even more severely.",
            "I put too much trust in those who wield power with my temple's hierarchy.",
    ...
    "Charlatan": {
        "Scam": [
            ...
            "I insinuate myself into people is lives to prey on their weaknesses, and secure their fortunes.",
        ...
        "Trait": [
            ...
            "I am a born gambler who cannot resist taking a risk for potential payout.",
            "I lie about almost everything, even when there is no good reason to.",
            "Sarcasm and insults are my weapons of choice.",
            "I keep multiple holy symbols on me and invoke whatever deity might come in useful at any given time.",
            "I pocket anything I see that might have some value."
        ],
        "Ideal": [
            "Independence - I am a free spirit, no one tells me what to do.",
            "Fairness - I never target people who can not afford to lose a few coins.",
        ...
        "Bond": [
            ...
            "A powerful person killed someone I loved. Someday soon, I will have my revenge.",
        ...
        "Flaw": [
            ...
            "I am too greedy for my own good. I cannot resist taking a risk if there’s money involved.",
            "I cannot resist swindling people who are more powerful than me.",
            "I hate to admit and will hate myself for it, but I will run and hide to preserve my own hide if the going gets tough."
        ],
    },
    "Criminal": {
        "Specialty": [
        ...
        "Flaw": [
            "When I see something valuable, I can not think about anything but how to steal it.",
    ...
    "Guild": {
        ...
        "Trait": [
            "I believe that anything worth doing is worth doing right. I ca not help it – I am a perfectionist.",
    ...
    "Outlander": {
        ...
        "Flaw": [
            ...
            "I remember every insult I’ve received and nurse a silent resentment toward anyone who hass ever wronged me.",
...
#Backgrounds that are variants but still have the same stats
BACKGROUND["Spy (Criminal Variant)"] = BACKGROUND["Criminal"]
BACKGROUND["Gladiator (Entertainer Variant)"] = BACKGROUND["Entertainer"]
BACKGROUND["Guild Merchant (Guild Artisan Variant)"] = BACKGROUND["Guild"]
BACKGROUND["Guild Artisan"] = BACKGROUND["Guild"]
BACKGROUND["Knight (Noble Variant)"] = BACKGROUND["Noble"]
BACKGROUND["Pirate (Sailor Variant)"] = BACKGROUND["Sailor"]

PERSONALITY_TRAITS = BACKGROUND #Leave after BACKGROUND
