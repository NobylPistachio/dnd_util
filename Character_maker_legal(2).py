...
Gn = ["Desert Gnome", "Forest Gnome", "Rock Gnome", "Svirfneblin Gone"]
...
if race == "Aarakocra":
    ArblnA = ["Air", "Airborn", "Airman", "Breeze", "Cloud", "Current", "Cyclone", "DeAera", "DeAerag", "DeAerk"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["DeAerka", "DeAial", "DeAialro", "DeAldug", "DeAldugek", "DeAur", "DeAurin", "DeDeekek", "DeDeelek", "DeErrk"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["DeErrok", "DeHeehk", "DeHelehk", "DeIkki", "DeIkkit", "DeIleak", "DeIlek", "DeKilco", "DeKilcop", "DeKleeck"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["DeKloock", "DeLagin", "DeLugin", "DeOerett", "DeOorr", "DeOusl", "DeOust", "DeQuaf","DeQuet", "DeQuierk" ]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["DeQuilet", "DeQuizik", "DeQuko", "DeRani", "DeRenzu", "DeSalleek", "DeSazel", "DeSejlik", "DeSileg", "DeUnok"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["DeUrreek", "DeZeed", "DeZelid", "DeZelip", "DeZiko", "DeZygic", "DeZylex", "Flow", "Fly", "Gale"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Galeborn", "Galeman", "Glide", "Gust", "Lift", "Sky", "Skybirch", "Skyborn", "Skybranch", "Skyelm"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Skyfield", "Skygarden", "Skygrove", "Skylily", "Skymaple", "Skymeadow", "Skyoak", "Skyorchid", "Skypine", "Skyrose"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Skyspurce", "Skywood", "Soar", "Storm", "Sunbirch", "Sunborn", "Sunbranch", "Sunelm", "Sunfield", "Sunling"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Sungarden", "Windgarden", "Sungrove", "Windgrove", "Whirlwind", "Wind", "Windborn", "Windman", "Windson", "Zephyr"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Aera", "Aerag", "Aerk", "Aerka", "Aial", "Aialro", "Aldug", "Aldugek", "Aur", "Aurin"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Deekek", "Deelek", "Errk", "Errok", "Heehk", "Helehk", "Ikki", "Ikkit", "Ileak", "Ilek", ]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Kilco", "Kilcop", "Kleeck", "Kloock", "Lagin", "Lugin", "Oerett", "Oorr", "Ousl", "Oust"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Quaf", "Quet", "Quierk", "Quilet", "Quizik", "Quko", "Rani", "Renzu","Salleek", "Sazel", ]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Sejlik", "Sileg", "Unok", "Urreek", "Zeed", "Zelid", "Zelip", "Ziko", "Zygic", "Zylex"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Aera", "Aerag", "Aerk", "Aerka", "Aial", "Aialro", "Aldug", "Aldugek", "Aur", "Aurin"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Deekek", "Deelek", "Errk", "Errok", "Heehk", "Helehk", "Ikki", "Ikkit", "Ileak", "Ilek", ]
        ...
        Fsnm = random.choice(Mtfns)
if race == Drag:
    ArblnA = ["Achebe", "Ademola", "Adeoye", "Adesida", "Adesina", "Adeyemi", "Aguda", "Akenzua", "Akerele", "Akiloye"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Akinjide", "Akintola", "Akinyemi", "Akpabio", "Akunyili", "Alakija", "Alamieyeseigha", "Amaechi", "Anenih", "Anikulapokuti", "Asaridokubo"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Attah", "Awolowo", "Ayim", "Azikiwe", "Babangida", "Balewa", "Balogun", "Bamgboshe", "Bankole"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Bello", "Biobaku", "Boro", "Buhari", "Chukwumereije", "Danjuma", "Dimka", "Diya", "Effiong", "Egwu"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Ekwensi", "Eze", "Ezekwesili", "Fagbure", "Falana", "Gbadamosi", "Gowon", "Ibori", "Igbinedion", "Igwe"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Ironsi", "Iweala", "Iwu", "Jaja", "Jakande", "Jang", "Jomogbomo", "Kalejaiye", "Kalu", "Madaki"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Magoro", "Mbadinuju", "Mbanefo", "Ngige", "Nnamani", "Nzeogwu", "Obasanjo", "Obi", "Odili", "Ohakim"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Ojukwu", "Okadigbo", "Okafor", "Okar", "Okeke", "Okereke", "Okilo", "Okiro", "Okonjo", "Okonkwo"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Okorie", "Okotieboh", "Okoye", "Okpara", "Olanrewaju", "Omehia", "Onobanjo", "Onwuatuegwu", "Onwudiwe", "Onyejekwe"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Orji", "Oyenusi", "Oyinlola", "Sarowiwa", "Sekibo", "Solarin", "Soyinka", "Tinibu", "Uba", "Yaradua"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        EllnA = ["Abdoul", "Abdkarim", "Abdoulaye", "Aboubacar", "Adama", "Ahmed", "Ali", "Alou", "Baba", "Bakary"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Bouba", "Boubacar", "Boureima", "Celestin", "Cheick", "Dango", "Daniel", "Daouda", "Djeïdy", "Djibril"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Drissa", "Felicien", "Fode", "Ibrahim", "Ibrahima", "Issa", "Jacob", "Karim", "Khadafi", "Konaté"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Lassine", "Louis", "Mahamadou", "Mamadou", "Moctar", "Modibo", "Mohamed", "Moussa", "Naly", "Oumar"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Ousmane", "Salif", "Seydou", "Siaka", "Souleymane", "Soumaila", "Yahirou", "Yaya", "Youba", "Youssouf"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Fsnm = random.choice(Ellns)
    if sex == "Female":
        EllnA = ["Abibatou", "Agna", "Aicha", "Aiicha", "Aissata", "Anita", "Armande", "Assitan", "Binette", "Bintou"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Chloe", "Christiane", "Deni", "Diahara", "Diarra", "Djello", "Djeneba", "Djenebou", "Djilla", "Estou"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Fanta ", "Fatim", "Fatou", "Kanouta", "Germaine", "Haoua", "Hawa", "Hawam", "Jeanne", "Kadidia"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Kady", "Korotoumou ", "Lea", "Leila", "Mariam", "Mary", "Mathi", "Meryam", "Micheline", "Mounaissa"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Nene", "Oumou", "Oumouba", "Oumouk", "Pauline", "Rama", "Soumba", "Stephanie", "Tall", "Zahra"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Fsnm = random.choice(Ellns)
if race == Dwar:
    ArblnA = ["Amber", "Amethyst", "Anvil", "Blacksmith", "Boulder", "Boulderbreak", "Boulderman", "Boulderson", "Clay", "Cliff"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Coal", "Coalman", "Coalson", "Cobalt", "Cobblestone", "Copper", "Copper", "Darkrock", "Darkstone", "Deeprock" ]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Deepstone", "Diamond", "Dirt", "Dune", "Earth", "Earthrock", "Earthstone", "Emerald", "Forge", "Forgeman" ]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Forgeson", "Gold", "Goldforge", "Goldhammer", "Goldsmith", "Gravel", "Ground", "Hammer", "Hammerman", "Hammerson" ]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Highrock", "Highstone", "Hill", "Hillson", "Hillrock", "Hillstone", "Ingot",  "Iron", "Ironforge", "Ironhammer" ]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Ironsmith", "Ironson", "Jade", "Lead", "Marble", "Marblebreak", "Marbleson", "Mesa", "Metal", "Mineral" ]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Mineshaft", "Mossrock", "Mosstone", "Mountain", "Mountainrock", "Moutainstone", "Mythril", "Nickel", "Onyx", "Opal"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Ore", "Orichalcum", "Pebble", "Quartz", "Quarry", "Rock", "Rockbreak", "Rockhammer", "Rockman", "Rockson" ]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Salt", "Sand", "Sapphire", "Silver", "Silverforge", "Silversmith", "Smith", "Smithson", "Soil", "Steelsmith"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Stone", "Stonebreak", "Stoneman", "Stonesmith", "Stoneson", "Tin", "Topaz", "Tunnel", "Tunnelsmith", "Zicron"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Aaron", "Alexander", "Anton", "Ben", "David", "Elias", "Emil", "Erik", "Fabian", "Felix"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Fynn", "Hannes", "Henry", "Jakob", "Jan", "Jannis", "Jonah", "Jonas", "Jonathan", "Julian"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Karl", "Leo", "Leonard", "Levi", "Liam", "Linus", "Luca", "Luis", "Lukas", "Mads"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Matteo", "Max", "Maximilian", "Mika", "Milan", "Moritz", "Niklas", "Noah", "Oskar", "Paul"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Philipp", "Raphael", "Samuel", "Simon", "Theo","Tim", "Tom", "Vincent", "Yannic", "Leon"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Alina", "Amelie", "Anna", "Charlotte", "Clara", "Elena", "Elisa", "Ella", "Emilia", "Emily"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Emma", "Frieda", "Greta", "Hannah", "Helena", "Ida", "Isabella", "Johanna", "Julia", "Lara" ]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Laura", "Lea", "Lena", "Leni", "Leonie", "Lia", "Lilly",  "Lina", "Lisa", "Lotta"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Luisa", "Maja", "Maria", "Marie", "Marlene", "Mathilda", "Melina", "Mia", "Mila", "Mira"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Nele", "Nora", "Paula", "Pauline", "Pia", "Sarah", "Sofia", "Sophie", "Viktoria", "Yuna" ]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
if race == Elf:
    ArblnA = ["Brightbranch", "Brightform", "Brightgarden", "Brightgroove", "Brightmeadow", "Feybirch", "Feyborn", "Feybranch", "Feyelm", "Feyfield"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Feyform", "Feygarden", "Feygrove", "Feylily", "Feyling", "Feyman", "Feymaple", "Feymeadow", "Feyoak", "Feyorchid"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Feypine", "Feyrose", "Feyson", "Feyspurce", "Feywood", "Goldbirch", "Goldbranch", "Goldelm", "Goldfield", "Goldgrove"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Goldlily", "Goldmaple", "Goldoak", "Goldorchid", "Goldpine", "Goldrose", "Goldspurce", "Goldwood", "Silverbirch", "Silverbranch"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Silverelm", "Silverfield", "Silvergarden", "Silvergrove", "Silverlily", "Silvermaple", "Silvermeadow", "Silveroak", "Silverorchid", "Silverpine"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Silverrose", "Silverspurce", "Silverwood", "Skybirch", "Skybranch", "Skyelm", "Skyfield", "Skygarden", "Skygrove", "Skylily"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Skymaple", "Skymeadow", "Skyoak", "Skyorchid", "Skypine", "Skyrose", "Skyspurce", "Skywood", "Starbirch", "Starborn"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Starelm", "Starform", "Stargarden", "Starlily", "Starling", "Starman", "Starmaple", "Starmeadow", "Staroak", "Starorchid"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Starpine", "Starrose", "Starson", "Starspurce", "Starwood", "Sunbirch", "Sunbranch", "Sunelm", "Sunfield", "Sungarden"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Sungrove", "Sunlily", "Sunmaple", "Sunmeadow", "Sunoak", "Sunorchid", "Sunpine", "Sunrose", "Sunspurce", "Sunwood"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Francesco", "Alessandro", "Lorenzo", "Andrea", "Leonardo", "Mattia", "Matteo", "Gabriele", "Riccardo", "Tommaso" ]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Davide", "Giuseppe", "Antonio", "Federico", "Edoardo", "Marco", "Samuele", "Diego", "Giovanni", "Luca"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Christian", "Pietro", "Simone", "Nicolo", "Filippo", "Alessio", "Gabriel", "Michele", "Emanuele", "Jacopo"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Daniele", "Cristian", "Giacomo", "Vincenzo", "Salvatore", "Manuel", "Gioele", "Thomas", "Stefano", "Giulio"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Samuel", "Nicola", "Giorgio", "Luigi", "Daniel", "Elia", "Angelo", "Domenico", "Paolo", "Raffaele"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Sofia", "Giulia", "Aurora", "Giorgia", "Martina", "Emma", "Greta", "Chiara", "Sara", "Alice" ]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Gaia", "Anna", "Francesca", "Ginevra", "Noemi", "Alessia", "Matilde", "Vittoria", "Viola", "Beatrice"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Nicole", "Giada", "Elisa", "Rebecca", "Elena", "Arianna", "Mia", "Camilla", "Ludovica", "Maria"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Marta", "Melissa", "Bianca", "Gioia", "Asia", "Adele", "Eleonora", "Miriam", "Serena", "Benedetta"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Irene", "Angelica", "Ilaria", "Carlotta", "Caterina", "Margherita", "Alessandra", "Valentina", "Emily", "Laura"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
if race == Genasi:
    if Genasi == "Fire Genasi":
        EllnA = ["Flame", "Fire", "Burn", "Furnace", "Ember"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Heat", "Inferno", "Blaze", "Pyre", "Glow"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Sear", "Spark", "Hearth", "Sun", "Lava"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Volcano", "Flare", "Ignite", "Kindle", "Torch"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Light", "Lamp", "Lantern", "Flameborn", "Fireson"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Lsnm = random.choice(Ellns)
    if Genasi == "Earth Genasi":
        EllnA = ["Amethyst", "Boulder", "Clay", "Coal", "Cobblestone"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Darkboulder", "Darkrock", "Darkstone", "Deeprock", "Deepstone"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Diamond", "Dune", "Earth", "Emerald", "Gravel"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Ground", "Jade", "Mossrock", "Mosstone", "Mountain"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Mountainrock", "Moutainstone", "Opal", "Sapphire", "Stone"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Lsnm = random.choice(Ellns)
    if Genasi == "Water Genasi":
        EllnA = ["Water", "Ocean", "Sea", "Lake", "Creek"]
        Elln1 = random.choice(EllnA)
        EllnB = ["River", "Stream", "Deepwater", "Rain", "Iceman"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Iceberg", "Tide", "Wave", "Gulf", "Geyser"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Rapid", "Bay", "Brook", "Canal", "Channel"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Cove", "Cape", "Delta", "Estuary", "Harbor"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Lsnm = random.choice(Ellns)
    if Genasi == "Air Genasi":
        EllnA = ["Air", "Airborn", "Airman", "Breeze", "Cloud"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Current", "Cyclone", "Flow", "Fly", "Gale"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Galeborn", "Galeman", "Glide", "Gust", "Lift"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Sky", "Skyborn", "Soar", "Storm", "Whirlwind"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Wind", "Windborn", "Windman", "Windson", "Zephyr"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Lsnm = random.choice(Ellns)
    if sex == "Male":
        MtfnA = ["An", "AnDung", "Bao", "Bay", "Buu", "Ca", "Chien", "Cong", "Cuong", "Danh"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Duc", "Ha", "Hien", "Hieu", "Hieú", "Hoang", "Hung", "Huu", "Huy", "Huynh"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Kim", "Lap", "Le", "Long", "Minh", "Nam", "Nghi", "Nghia", "Ngu", "Nguyen"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Nien", "Phuoc", "Quan", "Quy", "Tai", "Tam", "Teo", "Teo", "Thien", "Tin"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Toan", "Trai", "Trang", "Trong", "Trung", "Truuc", "Tuan", "Van", "Vien", "Viet"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Am", "Anh", "Be", "Bian", "Ca", "Cai", "Cam", "Chau", "Cuc", "Ha"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Hai", "Hanh", "Hao", "Hoa", "Hòng", "Huong", "Hwa", "Hyunh", "KimCuc", "Kimly"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Lang", "Le", "Lien", "Linh", "Mai", "My", "Ngoc", "Ngocbich", "Ngon", "Nguyen"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Nguyet", "Nhung", "Nu", "Phoung", "Phuong", "Sang", "Tai", "Thanh", "Thao", "Thi"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Thu", "Thuy", "Trang", "Truc", "Tu", "Tuyen", "Tuyet", "Ut", "Xuan", "Yen"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
if race == Gnome:
    ArblnA = ["Archer", "Bader", "Bailer", "Bailey", "Baker", "Bannister", "Barber", "Bard", "Barker", "Baxter"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Becker", "Boatman", "Boatwright", "Brewer", "Builder", "Carpenter", "Carter", "Cartwright", "Chaffer", "Chandler"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Chaplin", "Clark", "Cleric", "Cobbler", "Collier", "Cook", "Cookie", "Cooper", "Courier", "Craft"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Decker", "Dempster", "Draper", "Driver", "Dyer", "Farmer", "Fisher", "Fletcher", "Forester", "Foster"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Fowler", "Fuller", "Gage", "Gardener", "Garner", "Glover", "Guard", "Hayward", "Healer", "Hunt"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Hunter", "Judge", "Judge", "Kelner", "Key", "Knight", "Lawman", "Lawson", "Mage", "Mason"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Mayer", "Mercer", "Miller", "Painter", "Palmer", "Parker", "Piper", "Plummer", "Porter", "Potter"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Reeve", "Rhyder", "Sawyer", "Scribe", "Sealer", "Sexton", "Sheppard", "Shipwright", "Slater", "Slaughter"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Smith", "Stringer", "Tamer", "Thatcher", "Tinker", "Todd", "Toller", "Trainer", "Tuner", "Turner"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Wainwright", "Waker", "Walker", "Waller", "Warf", "Webb", "Woodman", "Wright", "Writer", "Zaiger"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Adam",  "Alexander",  "Allen",  "Anderson",  "Bailey",  "Baker",  "Barnes",  "Bell",  "Bennett",  "Brooks"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Aguilar", "Alonso", "Alvarez", "Andres", "Arias", "Blanco", "Bravo", "Caballero", "Cabrera", "Calvo", ]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Campos", "Cano", "Carmona", "Carrasco", "Castillo", "Castro", "Cortes", "Crespo", "Cruz", "Delgado"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Ibanez", "Iglesias", "Izquierdo", "Jimenez", "Leon", "Lopez", "Lorenzo", "Lozano", "Marcos", "Marin"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Rodriguez", "Roman", "Romero", "Rubio", "Ruiz", "Saez", "Sanchez", "Santos"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Abril", "Adriana", "Agustina", "Alejandra", "Amanda", "Ana Sofia", "Andrea", "Antonella", "Antonia", "Ariana"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Bianca", "Camila", "Carolina", "Catalina", "Daniela", "Elena", "Emilia", "Emily", "Emma", "Florencia"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Gabriela", "Guadalupe", "Isabella", "Ivanna", "Juana", "Julieta", "Lucia", "Luciana", "Maite", "Manuela"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["María", "Fernanda", "Estefani", "Mariana", "Martina", "Mía", "Natalia", "Nicole", "Paula", "Rafaela"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Regina", "Renata", "Samantha", "Sanz", "Sara", "Serrano", "Sofia", "Soler", "Soto", "Suarez"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
if race == "Goliath":
    ArblnA = ["Aimeilagian", "Aimeilakanu", "Aimeilakiv", "Aimeilathai", "Aimeilathi", "Aimeiliaga", "Aimeiliana", "Aimeiliano", "Aimeillago", "Aimeilolavi"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Anakalagian", "Anakalakanu", "Anakalakiv", "Anakalathai", "Anakalathi", "Anakaliaga", "Anakaliana", "Anakaliano", "Anakallago", "Anakalolavi"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Elaniagian", "Elaniakanu", "Elaniakiv", "Elaniathai", "Elaniathi", "Elaniiaga", "Elaniiana", "Elaniiano", "Elanilago", "Elaniolavi"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Gathakagian", "Gathakakanu", "Gathakakiv", "Gathakathai", "Gathakathi", "Gathakiaga","Gathakiana", "Gathakiano", "Gathaklaga", "Gathakolavi"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Kalagagian", "Kalagakanu", "Kalagakiv", "Kalagathai", "Kalagathi", "Kalagiaga", "Kalagiana", "Kalagiano", "Kalaglaga", "Kalagolavi"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Lithmoragian", "Lithmorakanu", "Lithmorakiv", "Lithmorathai", "Lithmorathi", "Lithmoriaga", "Lithmoriana", "Lithmoriano", "Lithmorlaga", "Lithmorolavi"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Mithagagian", "Mithagakanu", "Mithagakiv", "Mithagathai", "Mithagathi", "Mithagiaga", "Mithagiana", "Mithagiano", "Mithaglaga", "Mithagolavi"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Ogolakagian", "Ogolakakanu", "Ogolakakiv", "Ogolakathai", "Ogolakathi", "Ogolakiaga", "Ogolakiana", "Ogolakiano", "Ogolaklaga", "Ogolakolavi"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Thulagian", "Thulakanu", "Thulakiv", "Thulathai", "Thulathi", "Thuliaga", "Thuliana", "Thuliano", "Thullaga", "Thulolavi"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Zekatuagian", "Zekatuakanu", "Zekatuakiv", "Zekatuathai", "Zekatuathi", "Zekatuiaga", "Zekatuiana", "Zekatuiano", "Zekatulaga", "Zekatuolavi"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Aukan", "Aukned", "Belzed", "Bienzo", "Bogdo", "Cenhen", "Delvu", "Dirgag", "Dondid", "Eglath"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Egned", "Fengi", "Fondin", "Fopgun", "Fuldo", "Gaeal", "Ganden", "Gauthak", "Hogfin", "Ilikan"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Jondid", "Keothi", "Kuori", "Lokag", "Lukeg", "Magned", "Manneo", "Maveith", "Nalla", "Orilo"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Orvin", "Paavu", "Padin", "Pethani", "Qubig", "Sarzin", "Shonben", "Shontai", "Thalai", "Thotham"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Uthal", "Vamto", "Vaunea", "Venko", "Ventik", "Vimak", "Wagfor", "Waldu", "Zaxfor", "Zendu"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        ...
        Fsnm = random.choice(Mtfns)
if race == "Half-Elf":
    ArblnA = ["Skyoak", "Skyrose", "Skybirch", "Skyspurce", "Skypine", "Skyelm", "Skymaple", "Skywood", "Skyorchid",
              "Skylily"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Skygrove", "Skybranch", "Skyfield", "Skymeadow", "Skygarden", "Staroak", "Starrose", "Starbirch",
              "Starspurce", "Starpine"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Starelm", "Starmaple", "Starwood", "Starorchid", "Starlily", "Starmeadow", "Stargarden", "Sungrove",
              "Sunbranch", "Sunfield"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Sunoak", "Sunrose", "Sunbirch", "Sunspurce", "Sunpine", "Sunelm", "Sunmaple", "Sunwood", "Sunorchid",
              "Sunlily"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Sungrove", "Sunbranch", "Sunfield", "Sunmeadow", "Sungarden", "Goldoak", "Goldrose", "Goldbirch",
              "Goldspurce", "Goldpine"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Goldelm", "Goldmaple", "Goldwood", "Goldorchid", "Goldlily", "Goldgrove", "Goldbranch", "Goldfield",
              "Sunmeadow", "Sungarden"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Silveroak", "Silverrose", "Silverbirch", "Silverspurce", "Silverpine", "Silverelm", "Silvermaple",
              "Silverwood", "Silverorchid", "Silverlily"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Silvergrove", "Silverbranch", "Silverfield", "Silvermeadow", "Silvergarden", "Feyoak", "Feyrose",
              "Feybirch", "Feyspurce", "Feypine"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Feyelm", "Feymaple", "Feywood", "Feyorchid", "Feylily", "Feygrove", "Feybranch", "Feyfield", "Feymeadow",
              "Feygarden"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Starborn", "Starman", "Starson", "Starling", "Starform", "Feyborn", "Feyman", "Feyson", "Feyling",
              "Feyform"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["George", "Nick", "John", "Kostas", "Stelios", "Alex", "Chris", "Thanos", "konstantinos", "Jim" ]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Dimitris", "Christos", "Angelo", "Marios", "Apostolis", "Aris", "Panagiotis", "Manos", "Bill", "Peter"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Giannis", "Alexandros", "Lefteris", "Giorgos", "Andrew", "Alexander", "Steven", "Evangelos", "Billy", "Manolis"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Nicolas", "Gregory", "Pantelis", "Spiros", "Aggelos", "Antonis", "Sotiris", "Con", "Petros", "Constantine"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Alkinoos", "Achilleas", "Vasilhs", "Agim", "Stavros", "Christopher", "Vassilis", "Panos", "Vaggelis", "Michael"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Maria", "Katerina", "Anna", "Anastasia", "Christina", "Georgia", "Mary", "Helen", "Dimitra", "Elena"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Irene", "Konstantina", "Alexandra", "Eva", "Marianna", "Sofia", "Eleni", "Christine", "Zoe", "Joanna"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Theodora", "Angela", "Katherine", "Danae", "Catherine", "Nicole", "Olga", "Myrto", "Vasiliki", "Eleftheria"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Kate", "Efi", "Artemis", "Evi", "Fotini", "Agnes", "Loanna", "Nefeli", "Chrysa", "Marina"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Melina", "Sophia", "Stella", "Athina", "Despina", "Rafaela", "Dora", "Giota", "Alice", "Lydia"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
if race == Half:
    ArblnA = ["Aftor", "Alnig", "Argurra", "Barren", "Bregold", "Clearfarm", "Curun", "DeAlnig", "DeCurun", "DeEast"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Deepcoal", "Deepwood", "DeGalle", "DeHibran", "DeNorth", "DePanip", "DeRudra", "DeShore", "DeSkenin", "DeSouth"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["DeWest", "DeWillow", "Dwarfgate", "Dwarfland", "Eastbrook", "Eastsea", "Eastshore",  "Eastson", "Elfgate", "Elfland" ]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Elfport", "Elvcove", "Everdeep", "Farborn", "Farill", "Farsea", "Farson", "Fincoed", "Firstland", "Forest"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Forestedge", "Galle", "Ghenpoe", "Giantland", "Gnomeland", "Goldshore", "Goldtrust", "Greathill", "Gypte", "Hanan"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Hibran", "Hilltop", "Huland", "Impance", "Irongate", "Ishro", "Moruk", "Mountain", "Movet", "Nickletown" ]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Northbrook", "Northsea", "Oakgrove", "Orcland", "Panip", "Pronson", "Ravenshore", "Redcreek", "Rosemeadow", "Rudra" ]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Salan", "Seaborn", "Season", "Shipman", "Silvercrown", "Silverwood", "Skenin", "Soland", "Southbrook", "Southsea"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Southson", "Stangate","Stanland", "Steelburg", "Tiefland", "Traveller", "Westbrook", "Westdale", "Westsea", "Westshore"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Westson", "Wheatland", "Willowsbrook", "Wintergate", "Wood", "Woodedge", "Woodland", "Xena", "Yulin", "Zincton"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
    ...
    if sex == "Female":
        ...
        Fsnm = random.choice(Mtfns)
if race == "Half-Orc":
    ArblnA = ["Emilson",  "Mathiasson",  "Magnusson",  "Jonasson",  "Williamson",  "Oliverson",  "Noahson",  "Adrianson",  "Tobiasson",  "Eliasson"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Danielson",  "Henrikson",  "Sebastianson",  "Lucasson",  "Martinson",  "Andreasson",  "Benjaminson",  "Leonson",  "Sanderson",  "Alexanderson"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Liamson",  "Isakson",  "Jakobson",  "Kristianson",  "Akselson",  "Julianson",  "Fredrikson",  "Sondreson",  "Johannesson",  "Erikson"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Jonathanson",  "Mariusson",  "Filipson",  "Lukasson",  "Sigurdson",  "Markusson",  "Hakonson",  "Eirikson",  "Theoson",  "Oscarson"]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Mikkelson",  "Theodorson",  "Davidson",  "Gabrielson",  "Oskarson",  "Kasperson",  "Marcusson",  "Olavson",  "Evenson",  "Hermanson"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Aaronson ",  "Aidenson",  "Alexanderson",  "Andrewson",  "Anthonyson",   "Benjaminson",   "Calebson",   "Carterson",   "Charlesson",   "Christopherson"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Danielson",   "Davidson",   "Dylanson",   "Elijahson",   "Ethanson",  "Gabrielson",   "McGrayson",   "Henryson",   "Isaacson",   "Isaiahson"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Jackson",  "McJackson",   "Jacobson",   "Jamesson",   "McJaxon",   "Jaydenson",   "Johnson",   "Josephson",   "Joshuason",   "Julianson"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Levison",   "Liamson",   "Lincolnson",   "Loganson",   "Lucasson",   "Lukeson",   "McMason",   "Mateoson",   "Matthewson",   "Michaelson"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Nathanson",  "Noahson",   "Oliverson",   "Owenson",   "Ryanson",   "Samuelson",   "Sebastianson",   "Thomasson",   "Williamson",   "Wyattson"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        EllnA = ["Emil",  "Mathias",  "Magnus",  "Jonas",  "William",  "Oliver",  "Noah",  "Adrian",  "Tobias",  "Elias"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Daniel",  "Henrik",  "Sebastian",  "Lucas",  "Martin",  "Andreas",  "Benjamin",  "Leon",  "Sander",  "Alexander"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Liam",  "Isak",  "Jakob",  "Kristian",  "Aksel",  "Julian",  "Fredrik",  "Sondre",  "Johannes",  "Erik"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Jonathan",  "Marius",  "Filip",  "Lukas",  "Sigurd",  "Markus",  "Hakon",  "Eirik",  "Theo",  "Oscar"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Mikkel",  "Theodor",  "David",  "Gabriel",  "Oskar",  "Kasper",  "Marcus",  "Olav",  "Even",  "Herman"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Fsnm = random.choice(Ellns)
    if sex == "Female":
        EllnA = ["Emma",  "Nora",  "Sofie",  "Thea",  "Ingrid",  "Emilie",  "Mia",  "Julie",  "Anna",  "Ida"]
        Elln1 = random.choice(EllnA)
        EllnB = ["Linnea",  "Amalie",  "Maria",  "Sara",  "Ella",  "Maja",  "Leah",  "Tuva",  "Sofia",  "Frida"]
        Elln2 = random.choice(EllnB)
        EllnC = ["Vilde",  "Mathilde",  "Marie",  "Olivia",  "Jenny",  "Hanna",  "Aurora",  "Elise",  "Malin",  "Victoria"]
        Elln3 = random.choice(EllnC)
        EllnD = ["Oda",  "Selma",  "Hedda",  "Julia",  "Mari",  "Eline",  "Martine",  "Mina",  "Alma",  "Andrea"]
        Elln4 = random.choice(EllnD)
        EllnE = ["Pernille",  "Amanda",  "Mathea",  "Celine",  "Tiril",  "Isabella",  "Sarah",  "Mille",  "Synne",  "Hannah"]
        Elln5 = random.choice(EllnE)
        Ellns = [Elln1, Elln2, Elln3, Elln4, Elln4, Elln5]
        Fsnm = random.choice(Ellns)
if race == Human:
    ArblnA = ["Adams",  "Alexander",  "Allen",  "Anderson",  "Bailey",  "Baker",  "Barnes",  "Bell",  "Bennett",  "Brooks"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Brown",  "Bryant",   "Butler",  "Campbell",  "Carter",  "Clark", "Coleman",  "Collins" , "Cook",  "Cooper" ]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Cox", "Davis",  "Diaz",  "Edwards",  "Evans",  "Flores",  "Foster",  "Garcia",  "Gonzales",  "Gonzalez"]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Gray",  "Green",  "Griffin",   "Hall",  "Harris",  "Hayes","Henderson",  "Hernandez",  "Hill",  "Howard" ]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Hughes",  "Jackson",  "James",  "Jenkins",  "Johnson",  "Jones",  "Kelly",  "King",  "Lee",  "Lewis" ]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Long",  "Lopez",  "Martin",  "Martinez",  "Miller",  "Mitchell",  "Moore",  "Morgan",  "Morris",  "Murphy" ]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Nelson",  "Parker",  "Patterson",  "Perez",  "Perry",  "Peterson",  "Phillips",  "Powell",  "Price",  "Ramirez"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Reed",  "Richardson",  "Rivera",  "Roberts", "Robinson",  "Rodriguez",  "Rogers", "Ross", "Russell", "Sanchez"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Sanders",  "Scott",  "Simmons",  "Smith",  "Stewart",  "Taylor",  "Thomas",  "Thompson",  "Torres",  "Turner"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Walker",  "Ward",  "Washington",  "Watson",  "White",  "Williams",  "Wilson",  "Wood",  "Wright",  "Young"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Aaron", "Aiden", "Alexander", "Andrew", "Anthony", "Benjamin", "Caleb", "Carter", "Charles", "Christopher"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Daniel", "David", "Dylan", "Elijah", "Ethan", "Gabriel", "Grayson", "Henry", "Isaac", "Isaiah"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Jack", "Jackson", "Jacob", "James", "Jaxon", "Jayden", "John", "Joseph", "Joshua", "Julian", ]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Levi", "Liam", "Lincoln", "Logan", "Lucas", "Luke", "Mason", "Mateo", "Matthew", "Michael"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Nathan", "Noah", "Oliver", "Owen", "Ryan", "Samuel", "Sebastian", "Thomas", "William", "Wyatt"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
      MtfnA = ["Abigail", "Addison", "Amelia", "Aria", "Aubrey", "Audrey", "Ava", "Avery", "Bedegraine", "Bella" ]
      Mtfn1 = random.choice(MtfnA)
      MtfnB = ["Brooklyn", "Camila", "Charlotte", "Chloe", "Claire", "Eleanor", "Elizabeth", "Ella", "Ellie", "Emily"]
      Mtfn2 = random.choice(MtfnB)
      MtfnC = ["Evelyn", "Grace", "Hannah", "Harper", "Hazel", "Isabella", "Layla", "Leah", "Lillian", "Lily"]
      Mtfn3 = random.choice(MtfnC)
      MtfnD = ["Luna", "Madison", "Mia", "Mila", "Natalie", "Nora", "Olivia", "Paisley", "Penelope", "Riley"]
      Mtfn4 = random.choice(MtfnD)
      MtfnE = ["Savannah", "Scarlett", "Skylar", "Sofia", "Sophia", "Stella", "Victoria", "Violet", "Zoe", "Zoey" ]
      Mtfn5 = random.choice(MtfnE)
      Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
      Fsnm = random.choice(Mtfns)
if race == "Tiefling":
    ArblnA = ["Abadi", "Abboud", "Almasi", "Amari", "Antar", "Antoun", "Arian", "Asfour",  "Asghar", "Asker"]
    Arbln1 = random.choice(ArblnA)
    ArblnB = ["Aswad", "Aswad", "Atiyeh", "Attia", "Awad", "Ba", "Baba", "Bahar", "Bahar", "Basara"]
    Arbln2 = random.choice(ArblnB)
    ArblnC = ["Baz", "Bishara", "Bitar", "Botros", "Boulos", "Boutros", "Cham", "Dagher", "Daher", "Deeb", ]
    Arbln3 = random.choice(ArblnC)
    ArblnD = ["Essa", "Fakhoury", "Ganem", "Ganim", "Gerges", "Ghannam", "Guirguis", "Hadad", "Haddad", "Haik", ]
    Arbln4 = random.choice(ArblnD)
    ArblnE = ["Hajjar", "Hakimi", "Halabi", "Hanania", "Handal", "Harb", "Isa", "Issa", "Kalb", "Kanaan"]
    Arbln5 = random.choice(ArblnE)
    ArblnF = ["Kassab", "Kassis", "Kattan","Khouri", "Khoury", "Kouri", "Koury", "Maalouf", "Maloof", "Malouf"]
    Arbln6 = random.choice(ArblnF)
    ArblnG = ["Maroun", "Masih", "Mifsud", "Mikhail", "Moghadam", "Morcos", "Nader", "Nahas", "Naifeh", "Najjar"]
    Arbln7 = random.choice(ArblnG)
    ArblnH = ["Naser", "Nassar", "Nazari", "Quraishi", "Qureshi", "Rahal", "Rahal", "Sabbag", "Sabbagh", "Safar"]
    Arbln8 = random.choice(ArblnH)
    ArblnI = ["Said", "Salib", "Saliba", "Samaha", "Sarraf", "Sayegh", "Seif", "Shadid", "Shalhoub", "Shammas"]
    Arbln9 = random.choice(ArblnI)
    ArblnJ = ["Shamon", "Shamoon", "Shammas", "Shamon", "Shamoon", "Shamoun", "Sleiman", "Tahan", "Tannous", "Toma"]
    Arbln10 = random.choice(ArblnJ)
    Arblns = [Arbln1, Arbln2, Arbln3, Arbln4, Arbln5, Arbln6, Arbln7, Arbln8, Arbln9, Arbln10]
    Lsnm = random.choice(Arblns)
    if sex == "Male":
        MtfnA = ["Abad", "Ahirm", "Akmen", "Amnon", "Andram", "Astar", "Balam", "Barakas", "Bathin", "Caim"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Chem", "Cimer", "Cressel", "Damakos", "Ekemon", "Euron", "Fenriez", "Forcas", "Habor", "Iados",]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Kairon", "Leucis", "Mamnen", "Mantus", "Marbas", "Melech", "Merihim", "Modean", "Mordai", "Mormo", ]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Morthos", "Nicor", "Nirgel", "Oriax", "Painmon", "Pelaios", "Purson", "Qemuel", "Raam", "Rimmon", ]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Thamuz", "Therai","Sammal", "Skamos", "Tethren", "Valifar", "Vassago", "Xappan", "Xepar", "Zephan"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
    if sex == "Female":
        MtfnA = ["Akta", "Anakis", "Armara", "Astaro", "Aym","Azza", "Beleth", "Bryseis", "Bune", "Criella"]
        Mtfn1 = random.choice(MtfnA)
        MtfnB = ["Damaia", "Decarabia", "Ea", "Gadreek", "Gomory", "Hecat", "Ishte", "Jezebeth", "Kali", "Kalista"]
        Mtfn2 = random.choice(MtfnB)
        MtfnC = ["Kasdeya", "Lerssa", "Lilith", "Makaria", "Manea", "Markosian", "Mastema", "Naamah", "Nemja"]
        Mtfn3 = random.choice(MtfnC)
        MtfnD = ["Nija", "Orianna", "Osah", "Phelaia", "Prosperine", "Purah", "Pyra", "Rieta", "Ronobe", "Ronwe"]
        Mtfn4 = random.choice(MtfnD)
        MtfnE = ["Seddit", "Seere", "Sekhmet", "Semyaza", "Shava", "Shax", "Sorath", "Uzza", "Vapula", "Vepar", "Verin"]
        Mtfn5 = random.choice(MtfnE)
        Mtfns = [Mtfn1, Mtfn2, Mtfn3, Mtfn4, Mtfn4, Mtfn5]
        Fsnm = random.choice(Mtfns)
...
Barb = ["Path of the Ancestral Guardian Barbarian", "Path of the Beast Barbarian", "Path of the Battleranger Barbarian", "Path of the Berserker Barbarian", "Path of the Storm Herold Barbarian", "Path of the Totem Warrior Barbarian", "Path of the Wild Magic Barbarian", "Path of the Zelot Barbarian"]
Barbarian = random.choice(Barb)
Bar = ["College of Glamor Bard", "College of Creation Bard", "College of Eloquence Bard", "College of Lore Bard", "College of Swords Bard", "College of Valor Bard", "College of Whispers Bards"]
Bard = random.choice(Bar)
Cle = ["Death Domain Cleric", 'Forge Domain Cleric', "Grave Domain Cleric", "Knowledge Domain Cleric", "Life Domain Cleric", "Light Domain Cleric", "Nature Domain Cleric", "Order Domain Cleric", "Peace Domain Cleric", "Tempest Domain Cleric", "Twilight Domain Cleric", "Trickery Domain Cleric", "War Domain Cleric", "Zeal Domain Cleric"]
Cleric = random.choice(Cle)
Dru = ["Circle of Dreams Druid", "Circle of Land Druid", "Circle of the Moon Druid", "Circle of the Sheppard Druid", "Circle of the Spores Druid", "Circle of the Stars Druid", "Circle of the Wildfire Druid"]
Druid = random.choice(Dru)
Fig = ["Arcane Archer Archetype Fighter", "Battle Master Archetype Fighter", "Cavalier Archetype Fighter", "Champion Archetype Fighter", "Eldrich Knight Archetype Fighter","Psi Warrior Archetype Fighter","Rune Archetype Fighter", "Samurai Archetype Fighter"]
Fighter = random.choice(Fig)
Mon = ["Way of the Drunken Warrior Monk", "Way of the Four Elements Monk", "Way of the Kensei Monk", "Way of the Open Hand Monk", "Way of the Shadow Monk", "Way of the Sun Soul Monk", "Way of Mercy Monk", "Way of the Astral Self"]
Monk = random.choice(Mon)
Pal= ["Oath of the Ancients Paladin", "Oath of Conquest Paladin", "Oath of the Crown Paladin", "Oath of Devotion Paladin", "Oath of Glory Paladin", "Oath of Redemption Paladin", "Oath of Vengeance Paladin", "Oath of the Watchers Paladin"]
Paladin = random.choice(Pal)
Ran = ["Beast Master Archetype Ranger", "Gloom Stalker Archetype Ranger", "Horizon Walker Archetype Ranger", "Hunter Archetype Ranger", "Monster Slayer Archetype Ranger", "Fey Wanderer Archetype Ranger", "Swarmkeeper Archetype Ranger"]
Ranger = random.choice(Ran)
Rog = ["Arcane Trickster Archetype Rogue", "Assassin Archetype Rogue", "Inquisitive Archetype Rogue", "Mastermind Archetype Rogue", "Mountebank Archetype Rogue", "Scout Archetype Rogue", "Swashbuckler Archetype Rogue", "Thief Archetype Rogue", "Phatnom Archetype Rogue", "Soulknife Archetype Rogue"]
Rogue = random.choice(Rog)
Sor = ["Draconic Bloodline Origin Sorcerer", "Divine Soul Origin Sorcerer", "Phoenix Origin Sorcerer", "Sea Origin Sorcerer", "Shadow Origin Sorcerer", "Stone Origin Sorcerer", "Storm Origin Sorcerer", "Wild Magic Origin Sorcerer", "Aberrant Mind Origin Sorcerer", "Aberrant Mind Origin Sorcerer", ]
Sorcerer = random.choice(Sor)
War = [ "Archfey Patron Warlock", "Celestial Patron Warlock", "Fiend Patron Warlock",  "Great Old One Patron Warlock", "Fathomless Patron Warlock", "Hexblade Patron Warlock", "Genie Patron Warlock"] #"Queen of Spiders Patron Warlock", "Ancient Dragon Patron Warlock", "Mysterious Feline Patron Warlock", "Raven Queen Patron Warlock", "Serpent Patron Warlock"]
Warlock = random.choice(War)
Wiz = ["Abjuration Arcane Tradition Wizard", "Bladesinger Arcane Tradition Wizard", "Conjuration Arcane Tradition Wizard", "Divination Arcane Tradition Wizard", "Evocation Arcane Tradition Wizard", "Illusion Arcane Tradition Wizard", "Necromancy Arcane Tradition Wizard", "Order of Scribes Arcane Tradition Wizard", "Transmutation Arcane Tradition Wizard", "War Arcane Tradition Wizard"]
